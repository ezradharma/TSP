            ...
            <img class="Charts" src={ImgAsset.HotelsComGraph}/>
                <div class="reward-plats container center">
                    <div>
                        ...
                        <a href="https://hoopladoopla.com/brand/hotelscom">
                    ...
                    <div>
                        ...
                        <a href="https://www.maxrebates.com/us/stores/Hotels.com/">
                            <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                        </a>
                    </div>
                    <div>
                        ...
                        <span>Best Rates: 4%</span>
                        <a href="https://www.rebatesme.com/en/stores/hotels-us">
                            <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                        </a>
                    </div>
                    <div>
                        ...
                        <span>Best Rates: 4%</span>
                        <a href="https://www.dollardig.com/store/hotels/">
                            <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                        </a>
                    </div>
                    <div>
                        ...
                        <a href="https://www.gocashback.com/stores/hotelsus">
                            <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                        </a>
                    </div>
                </div>
