...
export default function HotelComRates () {
    return (
        <>
        <div className='SearchWalmart_SearchWalmart'>
            ...
            <div id="wrap">
            <img class="Charts" src={ImgAsset.HotelsComGraph}/>
                <div class="reward-plats container center">
                    <div>
                        ...
                        <a href="https://hoopladoopla.com/brand/hotelscom?ref=VmQlavLryexqNoGMBARzx7AwYWkZJd5bj4z2EnRD">
                            <i class='fas'>&#xf105;</i>
                        </a>
                    </div>
                    <div>
                        ...
                        <a href="https://www.cashbackmonitor.com/go-to/MaxRebates/hotels.com">
                            <i class='fas'>&#xf105;</i>
                        </a>
                    </div>
                    <div>
                        ...
                        <span>Best Rates: 4%</span>
                        <a href="https://www.cashbackmonitor.com/go-to/RebatesMe/hotels.com">
                            <i class='fas'>&#xf105;</i>
                        </a>
                    </div>
                    <div>
                        ...
                        <span>Best Rates: 4%</span>
                        <a href="https://www.cashbackmonitor.com/go-to/Dollar-Dig/hotels.com">
                            <i class='fas'>&#xf105;</i>
                        </a>
                    </div>
                    <div>
                        ...
                        <a href="https://www.gocashback.com/r/1360354?url=https%3A%2F%2Fwww.gocashback.com%2Fstores%2Fhotelsus">
                            <i class='fas'>&#xf105;</i>
                        </a>
                    </div>
                </div>
