...
export default function AmazonRates () {
    return (
        <>
        <div className='SearchWalmart_SearchWalmart'>
            ...
            <div id="wrap">
            <img class="Charts" src={ImgAsset.AmazonGraph}/>
                <div class="reward-plats container center">
                    <div>
                        ...
                        <a href="https://hoopladoopla.com/brand/amazoncom">
                    ...
                    <div>
                        ...
                        <a href="https://www.maxrebates.com/us/stores/Amazon">
                            <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                        </a>
                    </div>
                    <div>
                        ...
                        <span>Best Rates: 4%</span>
                        <a href="https://www.rebatesme.com/en/stores/amazon">
                            <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                        </a>
                    </div>
                </div>
