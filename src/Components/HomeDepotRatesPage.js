            ...
            <img class="Charts" src={ImgAsset.HomeDepotGraph}/>
                <div class="reward-plats container center">
                    <div>
                        ...
                        <a href="https://hoopladoopla.com/brand/home-depot">
                    ...
                    <div>
                        ...
                        <a href="https://www.maxrebates.com/us/stores/home-depot">
                            <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                        </a>
                    </div>
                    <div>
                        ...
                        <span>Best Rates: 4%</span>
                        <a href="https://www.rebatesme.com/en/stores/homedepotus">
                            <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                        </a>
                    </div>
                    <div>
                        ...
                        <span>Best Rates: 4%</span>
                        <a href="https://www.dollardig.com/store/home-depot/">
                            <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                        </a>
                    </div>
                    <div>
                        ...
                        <a href="https://www.gocashback.com/stores/homedepot">
                            <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                        </a>
                    </div>
                </div>
