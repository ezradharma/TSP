        ...
        <div className='SearchWalmart_SearchWalmart'>
            ...
            <div class="reward-plats container center">
                <div>
                    ...
                    <a href="https://hoopladoopla.com/brand/walmart">
                ...
                <div>
                    ...
                    <a href="https://www.maxrebates.com/us/stores/Walmart?">
                        <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                    </a>
                </div>
                <div>
                    ...
                    <span>Best Rates: 4%</span>
                    <a href="https://www.rebatesme.com/en/stores/walmart-us">
                        <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                    </a>
                </div>
                <div>
                    ...
                    <span>Best Rates: 4%</span>
                    <a href="https://www.dollardig.com/store/walmart-cashback/">
                        <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                    </a>
                    </div>
                <div>
                    ...
                    <a href="https://www.gocashback.com/stores/walmart">
                        <h1><FaGreaterThan style={{fontSize: '50px', float: 'right', marginTop: '-90px'}}/></h1>
                    </a>
                </div>
                </div>
