...
const SearchAFilterHighestPage = () => {
  ...
  return (
    <>
      <Column className="bg-black_900 font-inter items-center mx-[auto] pr-[1px] py-[1px] w-[100%]">
        <header className="w-[100%]">
          <Row className="bg-light_blue_800 border border-black_900 border-solid items-center justify-between xl:p-[4px] lg:p-[4px] 2xl:p-[5px] 3xl:p-[6px] p-[7px] shadow-bs w-[100%]">
            <Img
              ...
              className="lg:h-[51px] xl:h-[58px] 2xl:h-[66px] 3xl:h-[79px] h-[86px] xl:ml-[10px] 2xl:ml-[11px] 3xl:ml-[13px] ml-[15px] lg:ml-[8px] rounded-radius43 w-[12%]"
              alt="TSPThree"
            />
        ...
        <Column className="items-center lg:mb-[54px] xl:mb-[62px] 2xl:mb-[69px] 3xl:mb-[83px] mb-[92px] lg:mt-[45px] xl:mt-[52px] 2xl:mt-[59px] 3xl:mt-[70px] mt-[78px] w-[40%]">
          <Row className="bg-cyan_200 border border-black_900 border-solid justify-between xl:p-[10px] 2xl:p-[11px] 3xl:p-[13px] p-[15px] lg:p-[8px] shadow-bs w-[100%]">
            <Img
          ...
          >
            ...
            <Row className="bg-cyan_200 border border-black_900 border-solid justify-between lg:my-[13px] xl:my-[15px] 2xl:my-[17px] 3xl:my-[21px] my-[23.5px] lg:p-[12px] xl:p-[14px] 2xl:p-[15px] 3xl:p-[19px] p-[21px] shadow-bs w-[100%]">
              <Img
...
export default SearchAFilterHighestPage;
