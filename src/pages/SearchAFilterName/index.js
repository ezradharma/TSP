...
const SearchAFilterNamePage = () => {
  ...
  return (
    <>
      <Column className="bg-black_900 font-inter items-center mx-[auto] lg:pb-[41px] xl:pb-[47px] 2xl:pb-[53px] 3xl:pb-[63px] pb-[70px] w-[100%]">
        <header className="w-[100%]">
          <Row className="bg-light_blue_800 border border-black_900 border-solid items-center justify-between lg:p-[2px] 2xl:p-[3px] xl:p-[3px] 3xl:p-[4px] p-[5px] shadow-bs w-[100%]">
            <Img
              src="images/img_tsp3.png"
              className="lg:h-[51px] xl:h-[58px] 2xl:h-[66px] 3xl:h-[79px] h-[86px] mb-[2px] lg:ml-[10px] xl:ml-[12px] 2xl:ml-[13px] 3xl:ml-[16px] ml-[18px] rounded-radius43 w-[11%]"
              alt="TSPThree"
            />
            ...
            <Row className="bg-blue_500 border border-gray_500 border-solid items-center justify-center lg:pr-[13px] xl:pr-[15px] 2xl:pr-[17px] 3xl:pr-[20px] pr-[23px] rounded-radius29 w-[19%]">
            ...
            <Column className="items-center 2xl:mr-[10px] 3xl:mr-[12px] mr-[14px] lg:mr-[8px] xl:mr-[9px] w-[2%]">
        ...
        <Column className="items-center mt-[105px] lg:mt-[61px] xl:mt-[70px] 2xl:mt-[79px] 3xl:mt-[95px] w-[40%]">
          <Row className="bg-cyan_200 border border-black_900 border-solid justify-between lg:p-[12px] xl:p-[14px] 2xl:p-[15px] 3xl:p-[19px] p-[21px] shadow-bs w-[100%]">
            <Img
          ...
          <Row className="bg-cyan_200 border border-black_900 border-solid justify-between lg:mt-[24px] xl:mt-[27px] 2xl:mt-[31px] 3xl:mt-[37px] mt-[41px] xl:p-[10px] 2xl:p-[11px] 3xl:p-[13px] p-[15px] lg:p-[8px] shadow-bs w-[100%]">
            <Img
          ...
          <List
            className="gap-[0] min-h-[auto] lg:mt-[27px] xl:mt-[31px] 2xl:mt-[35px] 3xl:mt-[42px] mt-[47px] w-[100%]"
            orientation="vertical"
          >
            <Row className="bg-cyan_200 border border-black_900 border-solid items-end lg:my-[13px] xl:my-[15px] 2xl:my-[17px] 3xl:my-[21px] my-[23.5px] lg:p-[14px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[22px] p-[25px] shadow-bs w-[100%]">
              <Img
            ...
            <Row className="bg-cyan_200 border border-black_900 border-solid lg:my-[13px] xl:my-[15px] 2xl:my-[17px] 3xl:my-[21px] my-[23.5px] lg:p-[10px] xl:p-[11px] 2xl:p-[12px] 3xl:p-[15px] p-[17px] shadow-bs w-[100%]">
              <Img
...
export default SearchAFilterNamePage;
