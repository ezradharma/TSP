...
const SearchAPage = () => {
  ...
  return (
    <>
      <Column className="bg-black_900 font-inter items-center mx-[auto] lg:pb-[47px] xl:pb-[54px] 2xl:pb-[61px] 3xl:pb-[73px] pb-[81px] w-[100%]">
        ...
        <Column className="items-center mt-[109px] lg:mt-[64px] xl:mt-[73px] 2xl:mt-[82px] 3xl:mt-[99px] w-[40%]">
          <List
            className="gap-[0] min-h-[auto] w-[100%]"
            orientation="vertical"
          >
            <Row className="bg-cyan_200 border border-black_900 border-solid items-end lg:my-[10px] xl:my-[12px] 2xl:my-[14px] 3xl:my-[16px] my-[18.5px] lg:p-[14px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[22px] p-[25px] shadow-bs w-[100%]">
              <Img
            ...
            <Row className="bg-cyan_200 border border-black_900 border-solid lg:my-[10px] xl:my-[12px] 2xl:my-[14px] 3xl:my-[16px] my-[18.5px] lg:p-[10px] xl:p-[11px] 2xl:p-[12px] 3xl:p-[15px] p-[17px] shadow-bs w-[100%]">
              <Img
            ...
            <Row className="bg-cyan_200 border border-black_900 border-solid justify-between lg:my-[10px] xl:my-[12px] 2xl:my-[14px] 3xl:my-[16px] my-[18.5px] lg:p-[12px] xl:p-[14px] 2xl:p-[15px] 3xl:p-[19px] p-[21px] shadow-bs w-[100%]">
              <Img
          ...
          <Row className="bg-cyan_200 border border-black_900 border-solid justify-between lg:mt-[22px] xl:mt-[25px] 2xl:mt-[28px] 3xl:mt-[34px] mt-[38px] xl:p-[10px] 2xl:p-[11px] 3xl:p-[13px] p-[15px] lg:p-[8px] shadow-bs w-[100%]">
            <Img
